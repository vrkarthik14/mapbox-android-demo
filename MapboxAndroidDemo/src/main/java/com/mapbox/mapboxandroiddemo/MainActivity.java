...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
  ...
  private void initializeModels() {
    ...
    exampleItemModels.add(new ExampleItemModel(
      R.id.nav_lab,
      R.string.activity_satellite_heatmap_event_title,
      R.string.activity_satellite_heatmap_event_description,
      new Intent(MainActivity.this, SatelliteHeatmapEventActivity.class),
      null,
      R.string.activity_satellite_heatmap_event_url, false, BuildConfig.MIN_SDK_VERSION
    ));
